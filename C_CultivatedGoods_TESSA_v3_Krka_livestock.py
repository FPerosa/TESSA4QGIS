...
# LivestockProducts_list =  ["Honey, natural","Beeswax"] # Krka 2
...
pilotArea_name = "Krka" #"BegeckaJama"
scenarioID = "RS3" #"CS"
    ...
    for cropType in mostImportantCrops_list:
       ...
       for f in Agriculture_products_layer.getFeatures():
           if f[idx_ESS] == 'agricultural product' : 
               ...
               GrossPrices_agriculture_sum_USD_per_year = GrossPrices_agriculture_sum_USD_per_year + gross_price_tmp
