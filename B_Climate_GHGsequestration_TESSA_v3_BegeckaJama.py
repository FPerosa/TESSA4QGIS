...
climate_reg3 = "Warm temperate moist" 
continent = "Europe"
country = "Serbia"
...
DrainedOrganicSoils = 0
Percentage_Drained_Tree = 0
Percentage_Drained_Grass = 0
Percentage_Drained_Crops = 0

LandUse_grassland =  "Grassland drained nutrient-poor" # or "Grassland deep-drained nutrient-rich" or "Grassland shallow-drained nutrient-rich"

# for CH4 emissions
heads_livestock_available=1 # in tot number/year and not per hectare!

statisticsYear = 2018
domesticAnimals_pilotArea = ["Sheep"] # ["Buffalo", "Sheep", "Goats", "Camels", "Horses", "Mules ans Asses", "Deer", "Alpacas", "Swine","Dairy", "Other cattle"]
Heads_bovine_per_yr = 0 # otherwise = None
Heads_dairyCows_per_yr = 0 # otherwise = None
Heads_pigs_per_yr= 0 # otherwise = None
Heads_sheep_per_yr= 25 # otherwise = None
Heads_goats_per_yr= 0 # otherwise = None

wildGrazers_presence = 1
wildGrazers_pilotArea = ["Small deer"]
#Heads_moose_per_yr_ha = 0
#Heads_elk_per_yr_ha = 0
#Heads_largeDeer_per_yr_ha = 0
#Heads_caribou_per_yr_ha = 0
#Heads_smallDeer_per_yr_ha = 0
#heads_wildGrazers_pilotArea_per_yr_ha = [wildGrazers_pilotArea, 
...
Heads_smallDeer_per_yr = 27 # 25 in CS, 27 in RS2
...
EmissionsCountry_tonN2O_per_yr = readTable_FAO_agricultureEmissions(FAO_table_agricultureEmissions, "2017", "Emissions (N2O)", "Agriculture total", country)
