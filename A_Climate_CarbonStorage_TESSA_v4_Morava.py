...
forest_type = "plantations" # "natural" # "plantations" or 
...
grassland_ecoZone = "Temperate grassland" # "Temperate non-forest" #"Temperate grassland" #  or  or "Temperate pasture"
...
# for BGB ---
tree_species = "Quercus spp." # "other broadleaf" # or "conifers" or "Eucalyptus spp." or "Quercus spp."
...
naturalness_type =  "native"  # "aggrading"  or  # "native" or "managed" 

# for SOIL ORGANIC CARBON
moisture_regime = "Dry" # choose between "Moist" or "Dry"
soil_type = "organic" # choose between "organic" or "mineral"
soil_type_fromMap = None # "high activity clay" # "high activity clay" or  "low activity clay" or "sandy" or "spodic" or "volcanic" or "wetland"
...
Genera_tree = "All" # Morava: Alnus, Pinus, Quercus (not in the list), Fraxinus (not in the list), Salix (not in the list)
Species_tree =  "All"
...
# harvest area
Area_woodHarvest_pilotArea_ha = 10000 # CS: 10000 RS2: 10000
...
fuelwood_or_charcoalRemoval = 0

#disturbances (illnesses or fire)
forestDisturbances = 0
Area_Disturbance_ha_yr = None
disturbance_info_m3_yr = 0
ForestDisturbance_m3_yr = 0 
...
if soil_type == "organic":
    ...
    for f in carbonStocks_layer.getFeatures():
        # multiply by the factor according to IPCC, 2006
        if f[idx_HAB]!=0:
            SoilOrganicCarbon_ton_per_ha_mean_tmp = f[idx_SOM]
            if f[idx_SOM] is None:
                SoilOrganicCarbon_ton_per_ha_mean_tmp = 0.0
            f[idx_TSOM] = SoilOrganicCarbon_ton_per_ha_mean_tmp*f[idx_HA]
        carbonStocks_layer.updateFeature( f )
    # commit changes
    carbonStocks_layer.commitChanges()
...
if woodHarvesting == 1 or fuelwood_or_charcoalRemoval == 1:
    ...
    if woodHarvesting == 1:
        ...
        Area_woodHarvest_country_ha = readTable_FAOSTAT_landuse(table_FAOSTAT_landuse,country2,FAOstats_year,"Planted Forest")
