...
statisticsYear = 2018
domesticAnimals_pilotArea = ["Other cattle","Swine"] # ["Buffalo", "Sheep", "Goats", "Camels", "Horses", "Mules ans Asses", "Deer", "Alpacas", "Swine","Dairy", "Other cattle"]
...
Heads_smallDeer_per_yr_ha = 4.1
heads_wildGrazers_pilotArea_per_yr_ha = [wildGrazers_pilotArea, [Heads_smallDeer_per_yr_ha]]
